...
class JRCCoastalFlood_inventory():
    def __init__(self):
        pass
    ...
    def inventory(self) -> Iterable[HazardResource]:
        ...
        return [
            HazardResource(
                ...
                indicator_id="storm_surge_level",
                indicator_model_gcm = 'historical',
                path="inundation_coastal/jrc/v1/strom_surge_level_{scenario}_{year}",
                params={},
                display_name="Coastal Storm Surge Level (JRC)",
                description="""
                ...
                map = MapInfo(
                    ...
                    colormap=Colormap(
                        ...
                        max_value=5.0,
                        units="meters"),
                    path="strom_surge_level_{scenario}_{year}_map",
...
class JRCCoastalFlood():
    ...
    def __init__(self, bucket_name, prefix, zarr_storage, temp_dir) -> None:
        ...
        version = 'v1'
        dataset_names = ["strom_surge_level_historical_1969p",
                        "strom_surge_level_rcp45_2099",
                        "strom_surge_level_rcp85_2099"]
    ...
    def create_affine_transform_from_mapbounds(self):
        ...
        F = bounds[1] # y-coordinate of the center of the upper left pixel
