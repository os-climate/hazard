...
class RAINEuropeanWinterStorm:
    ...
    def onboard_all(self, target: ReadWriteDataArray, download_dir: str):
        """Onboard a set of hazards."""
        self.onboard_single(target, download_dir)

    def run_all(self, target: ReadWriteDataArray):
        """Run through all processes for both scenario and historical data sets.
