        ...
        return [
            {
                "scenario": "historical",
                "year": 2010,
                "input_dataset_filename": "alpha_klima_historical_fire_probability_europe_2010_v1_1.nc",
            },
            {
                "scenario": "rcp4p5",
                "year": 2035,
                "input_dataset_filename": "alpha_klima_rcp_4p5_fire_probability_europe_2035_v1_1.nc",
            },
            {
                "scenario": "rcp8p5",
                "year": 2035,
                "input_dataset_filename": "alpha_klima_rcp_8p5_fire_probability_europe_2035_v1_1.nc",
            },
        ]
    ...
    def inventory(self) -> Iterable[HazardResource]:
        ...
        return [
            HazardResource(
                ...
                params={},
                display_name="Fire Probability (Alpha-Klima v1.0)",
                resolution="2500 m",
                description="""
