...
class TUDelftRiverFlood(IndicatorModel[BatchItem]):
    ...
    def batch_items(self) -> Iterable[BatchItem]:
        return [ BatchItem(scenario="historical", central_year=1971, input_dataset_filename="River_flood_depth_1971_2000_hist_{return_period}.tif"),
                 BatchItem(scenario="rcp4p5", central_year=2035, input_dataset_filename="River_flood_depth_2021_2050_RCP45_{return_period}.tif"),
                 BatchItem(scenario="rcp8p5", central_year=2035, input_dataset_filename="River_flood_depth_2021_2050_RCP85_{return_period}.tif"),
                 BatchItem(scenario="rcp4p5", central_year=2085, input_dataset_filename="River_flood_depth_2071_2100_RCP45_{return_period}.tif"),
                 BatchItem(scenario="rcp8p5", central_year=2085, input_dataset_filename="River_flood_depth_2071_2100_RCP85_{return_period}.tif")
                 ]
...
class TUDelftCoastalFlood(IndicatorModel[BatchItem]):
    ...
    def batch_items(self) -> Iterable[BatchItem]:
        return [ BatchItem(scenario="historical", central_year=1971, input_dataset_filename="Coastal_flood_depth_1971_2000_hist_{return_period}.tif"),
                 BatchItem(scenario="rcp4p5", central_year=2035, input_dataset_filename="Coastal_flood_depth_2021_2050_RCP45_{return_period}.tif"),
                 BatchItem(scenario="rcp8p5", central_year=2035, input_dataset_filename="Coastal_flood_depth_2021_2050_RCP85_{return_period}.tif"),
                 BatchItem(scenario="rcp4p5", central_year=2085, input_dataset_filename="Coastal_flood_depth_2071_2100_RCP45_{return_period}.tif"),
                 BatchItem(scenario="rcp8p5", central_year=2085, input_dataset_filename="Coastal_flood_depth_2071_2100_RCP85_{return_period}.tif")
                 ]
