    ...
    def inventory(self) -> Iterable[HazardResource]:
        ...
        return [
            HazardResource(
                ...
                path="inundation_river/jrc/v1/flood_depth_{scenario}_{year}",
                params={},
                display_name="River Flood Depth (JRC)",
                description="""
...
class JRCRiverFlood():
    ...
    def transform_matrix_to_epsg(self):
        """
        Transfrom from i-j matrix index to epsg using affine transformation.
...
# JRCRiverFlood_.create_tiles()

# JRCRiverFlood_inventory_ = JRCRiverFlood_inventory()
# JRCRiverFlood_inventory_.inventory()
